...
interface StudentQuizAttemptsPageProps {
  studentId: number;
}
...
export function StudentQuizAttemptsPage({ studentId }: StudentQuizAttemptsPageProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Quiz Attempts & Scores</h2>
        <p className="text-gray-600">View your past quiz attempts and performance scores</p>
      </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="text-center pt-2">
                    <p className={`text-2xl font-bold ${getScoreColor(attempt.score).split(' ')[1]}`}>
